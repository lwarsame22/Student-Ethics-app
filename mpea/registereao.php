       ...
       <div class="limiter">
          ...
          <span class="login100-form-title">
            EAO Sign Up
                        ...
                        <div class="wrap-input100 validate-input m-b-16" data-validate = "Please Enter Staff ID">
                            <input class="input100" type="text" name="userid" placeholder="Staff ID">
                            <span class="focus-input100"></span>
                        </div>

                        <div class="wrap-input100 validate-input m-b-16" data-validate = "Please Enter Staff First Name">
                            <input class="input100" type="text" name="firstname" placeholder="Staff First Name">
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter Staff Email">
                            <input class="input100" type="email" name="username" placeholder="Staff Email">
                            <span class="focus-input100"></span>
                        </div>
