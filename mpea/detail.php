        ...
        <div id="slider" class="box-shadow">
            ...
            <table class="price">
                <tr class="border_bottom">
                    <th width="10%"><h4>Sr. # </h4></th>

                    <th width="30%"><h4>Application Title </h4></th>
                    <th width="14%"><h4>Unit Code </h4></th>
                    <th width="19%"><h4>Submission Date</h4></th>
                    <th width="19%"><h4>Assigned Date</h4></th>
                    <th width="8%"><h4>View/Download </h4></th>
                </tr>
                <?php
                include("config.php");
                session_start();
